...
<%--@elvariable id="googleDriveProviderFactory" type="org.jahia.modules.googledriveprovider.flow.GoogleDriveProviderMountPointFactory"--%>
...
<script type="application/javascript">
    // get authorization code from google API


</script>
<div class="folderPickerApp" ng-app="folderPicker">
    <h2><fmt:message key="googleDriveProviderFactory"/></h2>
    <%@ include file="errors.jspf" %>

    <fmt:message var="selectTarget" key="googleDriveProviderFactory.selectTarget"/>
    <c:set var="i18NSelectTarget" value="${functions:escapeJavaScript(selectTarget)}"/>
    <div class="box-1" ng-controller="folderPickerCtrl" ng-init='init(${localFolders}, "${googleDriveProviderFactory.localPath}", "localPath", true, "${i18NSelectTarget}")'>
        <form:form modelAttribute="googleDriveProviderFactory" method="post">
            <fieldset title="local">
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <form:label path="root"><fmt:message key="googleDriveProviderFactory.root"/> <span style="color: red">*</span></form:label>
